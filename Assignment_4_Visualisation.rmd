...
From the summary of NA values, we can see that there is a totla of 207 null values from the dataset, 123 from the Drop variable and 84 from the Duration variable. 
